...
from fast_ap_reward import FastAPReward
...
class TripletLoss(nn.Module):
    ...
    def forward(self, inputs_col, targets_col, inputs_row, targets_row):
        loss_list, n = compute_loss_list(inputs_col, targets_col, inputs_row, targets_row)
...
def compute_loss_list(inputs_col, targets_col, inputs_row, targets_row):
    n = inputs_col.size(0)
...
class RewardTripletLoss(nn.Module):
    ...
    def forward(self, inputs_col, targets_col, inputs_row, targets_row):
        ...
        rewards = FastAPReward().compute_reward(inputs_col, targets_col)
